    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, max_length=11, null=True, validators=[django.core.validators.RegexValidator(code='invalid_cpf', message='O CPF deve ter exatamente 11 dígitos numéricos.', regex='^\\d{11}$')])),
                ...
                ('recommendations', models.ManyToManyField(blank=True, related_name='recommended_users', to='content.movie')),
